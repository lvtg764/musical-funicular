local BASE_PATH = "New folderp/"

print("[Cobalt] Starting local loader...")
print("[Cobalt] Current directory: " .. (workspace and "workspace" or "unknown"))

local function load(path)
    print("[Cobalt] Loading:", path)
    ...
    if not success then
        error("[Cobalt] Failed to read " .. path .. ": " .. tostring(content))
    end
